 ...
 */
public class PictureExplorer_Loan implements MouseMotionListener, ActionListener, MouseListener
{
  ...
  {
    Picture pix = new Picture("sol.jpg");
    Picture smallSol = pix.scale(0.5,0.5);
    smallSol.write("smallSol.jpg");
  }
